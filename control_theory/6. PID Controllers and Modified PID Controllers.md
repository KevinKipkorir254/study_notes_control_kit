...
$$\frac{Y[z]}{U[z]} = \frac{5421*z^2 - 1.081e04*z + 5389}{z^2 -1}$$

$G_{C2}$

$$\frac{Y[z]}{U[z]} = \frac{-3678*z^2 + 7349*z - 3670}{z^2 -1}$$

After the transformation we get:

$G_{c1}$

$$y[k] = y[k-2] + 5421*u[k] - 1.081e04*u[k-1] + 5389*u[k-2]$$

$G_{c2}$

$$y[k] = y[k-2] - 3678*u[k] - 7349*u[k-1] + 3670*u[k-2]$$
